...
const TECH = [
  ...
  },
  {
    ...
    detect: {
      scripts: [/c\.lytics\.io/i, /lytics/i],
      html: [/lytics/i, /jstag/i],
    },
  },
  {
...
const NETWORK_URL_TECHS = [
  { rx: /google-analytics\.com|googletagmanager\.com\/gtag/i, tech: { name: 'Google Analytics', category: 'Analytics & Optimization Platform', color: '#E37400' } },
