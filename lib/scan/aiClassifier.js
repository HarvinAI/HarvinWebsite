...
Respond with ONLY minified JSON: {"category":"...","subCategory":"...","businessModel":"...","region":"..."}
Rules:
...
- NEVER return "General", "Unknown", "Other" or an empty string for subCategory, businessModel or region.
...
function parseResult(text, { lockedCategory, categories }) {
  ...
  return { category, subCategory: subCategory || 'General', businessModel: businessModel || null, region: region || null };
}
