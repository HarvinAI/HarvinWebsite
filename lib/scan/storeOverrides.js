...
const STORE_OVERRIDES = [
  ...
  { domain: 'tanishq.co.in', offlineStores: '500+', category: 'Jewelry', subCategory: 'Fine Jewelry', region: 'India' },
  { domain: 'croma.com', offlineStores: '500+', category: 'Ecommerce/Retail', subCategory: 'Electronics', region: 'India' },
  { domain: 'pepperfry.com', offlineStores: '100-500', category: 'Home & Living', subCategory: 'Furniture', region: 'India' },
  { domain: 'nykaa.com', offlineStores: '100-500', category: 'Beauty & Personal Care', subCategory: 'D2C Brand', region: 'India' },
  { domain: 'meesho.com', offlineStores: 'Online only', category: 'Ecommerce/Retail', subCategory: 'Marketplace', region: 'India' },

  // Sites that don't expose store locator data
  { domain: 'chaipoint.com', offlineStores: '100-500', category: 'Food & Beverage', subCategory: 'Cafe Chain', region: 'India' },
  ...
  { domain: 'bombayshirts.com', offlineStores: '10-50', category: 'Fashion & Apparel', subCategory: 'Custom Shirts', region: 'Global' },

  // Vercel bot-protected sites
  { domain: 'foxtale.in', offlineStores: '100-500', category: 'Beauty & Personal Care', subCategory: 'Skincare', region: 'India' },
];
