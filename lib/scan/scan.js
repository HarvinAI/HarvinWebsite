...
async function scanSingleUrl(rawUrl, { forceRefresh = false, pageData = null } = {}) {
  ...
  // ── Extension signals (lightweight — no HTML) ──
  ...
  // ── Fetch HTML — with tight timeouts ──
  ...
  // When extension provides signals, skip the expensive browser launch
