...
const INDUSTRY_KEYWORDS = {
  ...
  'Health & Wellness': ['fitness equipment', 'gym equipment', 'workout gear', 'yoga mat', 'exercise equipment', 'treadmill', 'dumbbell', 'kettlebell', 'resistance band', 'exercise bike', 'sexual wellness', 'intimacy product', 'condom', 'condoms', 'pleasure product', 'personal massager', 'intimate care', 'aromatherapy', 'essential oil', 'self-care kit', 'blood pressure monitor', 'medical thermometer', 'first aid kit', 'compression wear', 'massage tool', 'foam roller', 'recovery tool', 'wellness product', 'health supplement', 'dietary supplement', 'sleep aid', 'melatonin', 'cbd oil', 'hemp product', 'anti-aging', 'collagen supplement', 'probiotic', 'gut health', 'immunity booster', 'pain relief', 'muscle recovery', 'joint support'],
  'Baby & Kids':       ['kids wear', 'baby care', 'toys', 'newborn', 'toddler', 'infant', 'baby clothes', 'nursery', 'diaper', 'stroller', 'baby monitor', 'car seat', 'pacifier', 'baby bottle', 'educational toy', 'puzzle', 'board game', 'action figure', 'doll', 'kids furniture', 'crib', 'toddler bed', 'baby skincare', 'learning kit', 'bpa-free', 'non-toxic toy', 'choking hazard'],
  'Pet Products':      ['pet food', 'dog food', 'cat food', 'pet care', 'pet supplies', 'dog treat', 'cat litter', 'pet grooming', 'pet collar', 'leash', 'pet bed', 'pet crate', 'pet toy', 'flea treatment', 'pet dental care', 'cat tree', 'scratching post', 'pet clothing', 'vet recommended'],
  'Electronics & Tech': ['electronics', 'gadget', 'smartphone', 'laptop', 'tech accessories', 'earbuds', 'headphone', 'smartwatch', 'charger', 'power bank', 'tablet', 'monitor', 'camera', 'drone', 'fitness tracker', 'smart ring', 'speaker', 'soundbar', 'microphone', 'gaming console', 'gaming keyboard', 'gaming mouse', 'controller', 'gaming chair', 'webcam', 'bluetooth', 'usb-c', 'wireless'],
  'Sports & Outdoor': ['camping gear', 'hiking gear', 'tent', 'sleeping bag', 'camp stove', 'cooler', 'bicycle', 'skateboard', 'surfboard', 'paddleboard', 'fishing gear', 'golf club', 'grill', 'outdoor lighting', 'hammock', 'sports equipment', 'sporting goods', 'sportswear', 'sports wear', 'cricket bat', 'badminton', 'fitness gear', 'sports gear', 'cycling', 'outdoor sports', 'team sports', 'sports store', 'sports shop', 'weather-resistant gear'],
  ...
  'Media & Entertainment': ['video streaming', 'streaming service', 'original series', 'live tv', 'sports streaming', 'cable replacement', 'stream movies', 'tv shows', 'original content', 'simultaneous streams', 'download for offline', 'ott platform', 'podcast platform', 'radio streaming', 'audiobook', 'ad-free listening', 'offline download', 'lossless audio', 'spatial audio', 'millions of songs', 'on-demand music', 'cloud gaming', 'game streaming', 'game subscription', 'game library', 'game pass', 'day-one release', 'gaming platform', 'web series', 'original movies'],
  'News & Media':      ['news', 'publishing house', 'editorial', 'journalism', 'newspaper', 'press release', 'media house', 'broadcast', 'news subscription', 'digital magazine', 'newsletter platform', 'premium newsletter', 'e-reading', 'kindle unlimited', 'paywall', 'ad-free reading', 'archive access', 'breaking news'],
  ...
  'Travel & Ticketing': ['travel agency', 'travel booking', 'flight booking', 'hotel booking', 'tour package', 'vacation package', 'resort booking', 'itinerary', 'holiday package', 'bus booking', 'train booking', 'cab booking', 'event ticketing', 'concert ticket', 'experience booking', 'vacation rental', 'best price guarantee', 'instant confirmation'],
  'Transportation & Mobility': ['ride-sharing', 'car-sharing', 'bike-sharing', 'scooter-sharing', 'parking subscription', 'ride credits', 'unlimited rides', 'rideshare app', 'taxi app', 'electric scooter rental', 'micro-mobility', 'public transit app', 'commuter pass', 'ride hailing', 'transportation app'],
  ...
  'Automotive':       ['car dealership', 'used cars', 'new cars', 'auto parts', 'car accessories', 'automobile', 'automotive', 'motorcycle', 'electric vehicle', 'car service', 'car wash', 'tire', 'tyre', 'engine oil', 'car insurance', 'test drive', 'showroom', 'auto repair', 'spare parts', 'car dealer', 'bike dealer', 'two wheeler', 'four wheeler'],
  ...
  'Cybersecurity':     ['cybersecurity', 'information security', 'endpoint security', 'firewall', 'intrusion detection', 'penetration testing', 'vulnerability assessment', 'threat intelligence', 'siem', 'zero trust', 'data protection', 'encryption', 'identity management', 'malware protection', 'ransomware', 'ddos protection', 'security operations center', 'cyber threat'],
  'Grocery & Supermarket': ['grocery store', 'supermarket', 'hypermarket', 'fresh produce', 'pantry', 'frozen food', 'dairy products', 'bakery items', 'meat and seafood', 'organic grocery', 'farm fresh', 'weekly basket', 'household essentials', 'bulk buying', 'grocery delivery', 'online grocery', 'instant delivery', 'grocery chain'],
  ...
  'Dating & Matchmaking': ['dating', 'matchmaking', 'matrimony', 'matrimonial', 'life partner', 'soul mate', 'find your match', 'singles', 'compatibility', 'swipe', 'dating app', 'online dating', 'speed dating', 'shaadi', 'vivah', 'rishta', 'biodata', 'horoscope matching', 'bride', 'groom', 'wedding match'],
  ...
  'Aquaculture & Fisheries': ['aquaculture', 'fishery', 'fish farming', 'seafood', 'shrimp', 'shellfish', 'marine fisheries', 'freshwater fish', 'hatchery', 'fish feed', 'seaweed', 'algae', 'aquaponics', 'fish processing', 'prawn farming', 'fish pond', 'trawler', 'fish fillet', 'cage culture', 'recirculating aquaculture'],
  ...
  'Publishing & Books': ['publishing', 'book publisher', 'self-publishing', 'periodical', 'academic publishing', 'digital publishing', 'comic book', 'graphic novel', 'isbn', 'manuscript', 'literary agent', 'printing press', 'bestseller', 'book store', 'bookshop', 'e-book', 'book launch'],
...
const SUB_INDUSTRY_KEYWORDS = {
  ...
  'Food & Beverage': {
    ...
    'Bakery & Baked Goods': ['bakery', 'bread', 'pastry', 'cake', 'cookies', 'baked goods', 'artisan bread'],
  ...
  'Health & Wellness': {
    ...
    'CBD & Herbal Products': ['cbd product', 'herbal supplement', 'hemp extract', 'botanical', 'herbal remedy'],
  ...
  'Electronics & Tech': {
    ...
    'Home Appliances': ['home appliance', 'washing machine', 'refrigerator', 'air conditioner', 'microwave', 'dishwasher'],
  },
  'Sports & Outdoor': {
  ...
  'Publishing & Books': {
    'Book Publishing (Fiction & Non-Fiction)': ['book publisher', 'fiction publisher', 'non-fiction', 'bestseller', 'literary fiction'],
...
async function extractCompanyMeta({ url, html, headers, metaMap, technologies, fetchPage, browserFetch, forceRefresh }) {
  ...
  // AI fallback: if category is still Unknown, use LLM to classify from domain name
  if ((!category || category === 'Unknown') && !knownBrand) {
    try {
  ...
  // ── Business Model Detection ──
  let businessModel = detectBusinessModel(html, url, offlineStores, technologies);
  // Fallback: derive from store count if detection returned null
  if (!businessModel) {
    if (offlineStores && offlineStores !== 'Online' && offlineStores !== 'Unknown') {
      businessModel = 'Omnichannel';
    } else {
      businessModel = 'Pure D2C';
    }
  }
  ...
  // Detect app presence from page HTML
  const { detectAppPresenceFromHTML } = require('./appPresence');
  const appDetection = detectAppPresenceFromHTML(html);

  const result = { category, subCategory, region, state, city, offlineStores, storeRawCount, businessModel, categoryConfidence, appPresence: appDetection.appPresence, iosAppUrl: appDetection.iosUrl, androidAppUrl: appDetection.androidUrl };
    ...
    await db.collection('company_meta').updateOne(
      { normalizedDomain },
      {
        $set: {
          ...
          categoryConfidence: result.categoryConfidence || 'low',
...
module.exports = { extractCompanyMeta, INDIA_STATES, INDIA_CITY_STATE, CITY_ALIASES, normalizeCity, formatDisplayLocation, lookupKnownBrand, D2C_ELIGIBLE_CATEGORIES };
