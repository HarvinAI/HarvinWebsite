...
const INDUSTRY_KEYWORDS = {
  ...
  'Health & Wellness': ['fitness equipment', 'gym equipment', 'workout gear', 'yoga mat', 'exercise equipment', 'treadmill', 'dumbbell', 'kettlebell', 'resistance band', 'exercise bike', 'sexual wellness', 'intimacy product', 'aromatherapy', 'essential oil', 'self-care kit', 'blood pressure monitor', 'medical thermometer', 'first aid kit', 'compression wear', 'massage tool', 'foam roller', 'recovery tool', 'wellness product', 'health supplement', 'dietary supplement'],
  ...
  'NGO & Non-Profit': ['ngo', 'non-profit', 'nonprofit', 'charity', 'donation', 'donate', 'philanthropy', 'social impact', 'humanitarian', 'volunteer', 'volunteering', 'relief fund', 'charitable trust', 'social enterprise', 'sustainable development', 'advocacy', 'awareness campaign', 'fundraising', 'crowdfunding for cause', 'underprivileged', 'marginalized', 'empowerment'],
...
const D2C_ELIGIBLE_CATEGORIES = new Set([
  ...
  'Office & Stationery', 'Ecommerce/Retail', 'Alcohol & Tobacco', 'Art & Collectibles',
