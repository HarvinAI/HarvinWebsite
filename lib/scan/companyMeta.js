...
const INDUSTRY_KEYWORDS = {
  ...
  'Food & Beverage':   ['food delivery', 'beverage', 'restaurant', 'cafe', 'coffee shop', 'snack', 'chocolate', 'bakery', 'meal kit', 'dining', 'cuisine', 'food menu', 'grocery', 'supermarket', 'protein bar', 'jerky', 'coffee beans', 'tea leaves', 'matcha', 'wine shop', 'winery', 'vineyard', 'craft beer', 'brewery', 'distillery', 'spirits brand', 'cocktail', 'supplement', 'vitamins', 'protein powder', 'collagen', 'probiotics', 'organic food', 'vegan food', 'gluten-free', 'keto', 'kombucha', 'energy drink', 'sparkling water', 'condiment', 'spices', 'sauce', 'nut butter', 'nutrition facts', 'non-gmo'],
