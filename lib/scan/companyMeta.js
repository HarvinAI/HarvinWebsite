...
async function extractCompanyMeta({ url, html, headers, metaMap, technologies, fetchPage, browserFetch, forceRefresh }) {
  ...
  const result = { category, subCategory, region, state, city, offlineStores, storeRawCount, businessModel, categoryConfidence, appPresence: appDetection.appPresence, iosAppUrl: appDetection.iosUrl, androidAppUrl: appDetection.androidUrl, brandName: ogSiteName || null };
