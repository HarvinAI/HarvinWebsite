...
const INDUSTRY_KEYWORDS = {
  ...
  'Alcohol & Tobacco': ['whisky', 'whiskey', 'vodka', 'rum', 'gin', 'tequila', 'brandy', 'wine', 'beer', 'craft beer', 'brewery', 'distillery', 'single malt', 'blended scotch', 'bourbon', 'champagne', 'prosecco', 'liquor', 'spirits', 'cocktail', 'bar', 'pub', 'lounge', 'tobacco', 'cigarette', 'cigar', 'hookah', 'vape', 'e-cigarette', 'nicotine', 'smoking'],
...
const SUB_INDUSTRY_KEYWORDS = {
  ...
  'Alcohol & Tobacco': {
    'Spirits':            ['whisky', 'whiskey', 'vodka', 'rum', 'gin', 'tequila', 'brandy', 'bourbon'],
    'Wine':               ['wine', 'champagne', 'prosecco', 'vineyard', 'winery', 'sommelier'],
    'Beer':               ['beer', 'craft beer', 'brewery', 'lager', 'ale', 'stout', 'ipa'],
