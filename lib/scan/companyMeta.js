...
const KNOWN_BRANDS = {
  ...
  'nike.com':        { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'adidas.com':      { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'adidas.co.in':    { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'puma.com':        { category: 'Fashion & Apparel', subCategory: 'Sportswear' },
  'reebok.com':      { category: 'Fashion & Apparel', subCategory: 'Sportswear' },
  'newbalance.com':  { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'asics.com':       { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'skechers.com':    { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'converse.com':    { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'vans.com':        { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'underarmour.com': { category: 'Fashion & Apparel', subCategory: 'Sportswear' },
  'zara.com':        { category: 'Fashion & Apparel', subCategory: 'Fast Fashion' },
  'hm.com':          { category: 'Fashion & Apparel', subCategory: 'Fast Fashion' },
  'uniqlo.com':      { category: 'Fashion & Apparel', subCategory: 'Casual Wear' },
  'gap.com':         { category: 'Fashion & Apparel', subCategory: 'Casual Wear' },
  'levis.com':       { category: 'Fashion & Apparel', subCategory: 'Denim & Jeans' },
  'levi.com':        { category: 'Fashion & Apparel', subCategory: 'Denim & Jeans' },
  'gucci.com':       { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'louisvuitton.com':{ category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'prada.com':       { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'burberry.com':    { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'ralphlauren.com': { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'calvinklein.com': { category: 'Fashion & Apparel', subCategory: 'Premium Fashion' },
  'tommyhilfiger.com':{ category: 'Fashion & Apparel', subCategory: 'Premium Fashion' },
  'armani.com':      { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'versace.com':     { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'balenciaga.com':  { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'dior.com':        { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'fendi.com':       { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'hermes.com':      { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'chanel.com':      { category: 'Fashion & Apparel', subCategory: 'Luxury Fashion' },
  'forever21.com':   { category: 'Fashion & Apparel', subCategory: 'Fast Fashion' },
  'asos.com':        { category: 'Fashion & Apparel', subCategory: 'Fast Fashion' },
  'shein.com':       { category: 'Fashion & Apparel', subCategory: 'Fast Fashion' },
  'nordstrom.com':   { category: 'Fashion & Apparel', subCategory: 'Department Store' },
  'macys.com':       { category: 'Fashion & Apparel', subCategory: 'Department Store' },
  'crocs.com':       { category: 'Fashion & Apparel', subCategory: 'Casual Footwear' },
  'birkenstock.com': { category: 'Fashion & Apparel', subCategory: 'Casual Footwear' },
  'clarks.com':      { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'timberland.com':  { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'bata.com':        { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'bata.in':         { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  // Custom Tailoring
  'bombayshirts.com':{ category: 'Fashion & Apparel', subCategory: 'Custom Shirts' },
  // Fashion & Apparel — India
  'manyavar.com':    { category: 'Fashion & Apparel', subCategory: 'Ethnic Wear' },
  'fabindia.com':    { category: 'Fashion & Apparel', subCategory: 'Ethnic Wear' },
  'biba.in':         { category: 'Fashion & Apparel', subCategory: 'Ethnic Wear' },
  'wforwoman.com':   { category: 'Fashion & Apparel', subCategory: 'Women\'s Wear' },
  'global.com':      { category: 'Fashion & Apparel', subCategory: 'Denim & Jeans' },
  'bewakoof.com':    { category: 'Fashion & Apparel', subCategory: 'Streetwear' },
  'thesouledstore.com':{ category: 'Fashion & Apparel', subCategory: 'Streetwear' },
  'snitch.co.in':    { category: 'Fashion & Apparel', subCategory: 'Men\'s Fashion' },
  'rfrk.in':         { category: 'Fashion & Apparel', subCategory: 'Streetwear' },
  'bonkers.co.in':   { category: 'Fashion & Apparel', subCategory: 'Streetwear' },
  'urbanic.com':     { category: 'Fashion & Apparel', subCategory: 'Women\'s Wear' },
  'nykdfashion.com': { category: 'Fashion & Apparel', subCategory: 'Women\'s Wear' },
  'pantaloons.com':  { category: 'Fashion & Apparel', subCategory: 'Multi-Brand Retail' },
  'lifestylestores.com':{ category: 'Fashion & Apparel', subCategory: 'Multi-Brand Retail' },
  'shoppersstop.com':{ category: 'Fashion & Apparel', subCategory: 'Department Store' },
  'ajio.com':        { category: 'Fashion & Apparel', subCategory: 'Multi-Brand Retail' },
  ...
  'woodland.in':     { category: 'Fashion & Apparel', subCategory: 'Outdoor & Adventure' },
  'campusshoes.com': { category: 'Fashion & Apparel', subCategory: 'Shoes & Sneakers' },
  'libertyshoes.com':{ category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'metrobrands.com': { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'mochi.in':        { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  'mochishoes.com':  { category: 'Fashion & Apparel', subCategory: 'Footwear' },
  // Jewelry
  'tanishq.co.in':   { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'caratlane.com':    { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'bluestone.com':    { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'kalyan.com':       { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'kalyanjewellers.net':{ category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'malabargold.com':  { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'pngjewellers.com': { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'joyalukkas.com':   { category: 'Jewelry', subCategory: 'Fine Jewelry' },
  'tiffany.com':      { category: 'Jewelry', subCategory: 'Luxury Jewelry' },
  'cartier.com':      { category: 'Jewelry', subCategory: 'Luxury Jewelry' },
  'swarovski.com':    { category: 'Jewelry', subCategory: 'Crystal & Fashion Jewelry' },
  'pandora.net':      { category: 'Jewelry', subCategory: 'Fashion Jewelry' },
  // Beauty & Personal Care
  'nykaa.com':        { category: 'Beauty & Personal Care', subCategory: 'Beauty Marketplace' },
  'mamaearth.in':     { category: 'Beauty & Personal Care', subCategory: 'Natural & Organic' },
  'mcaffeine.com':    { category: 'Beauty & Personal Care', subCategory: 'Skincare' },
  'plumgoodness.com': { category: 'Beauty & Personal Care', subCategory: 'Clean Beauty' },
  'myglamm.com':      { category: 'Beauty & Personal Care', subCategory: 'Makeup' },
  'sugarcosmetics.com':{ category: 'Beauty & Personal Care', subCategory: 'Makeup' },
  'lorealparis.co.in':{ category: 'Beauty & Personal Care', subCategory: 'Premium Beauty' },
  'maccosmetics.com': { category: 'Beauty & Personal Care', subCategory: 'Premium Beauty' },
  'sephora.com':      { category: 'Beauty & Personal Care', subCategory: 'Beauty Retail' },
  'bathbodyworks.com':{ category: 'Beauty & Personal Care', subCategory: 'Bath & Body' },
  'forestessentialsindia.com':{ category: 'Beauty & Personal Care', subCategory: 'Luxury Ayurvedic' },
  'thebodyshop.com':  { category: 'Beauty & Personal Care', subCategory: 'Natural Beauty' },
  'beardo.in':        { category: 'Beauty & Personal Care', subCategory: 'Men\'s Grooming' },
  'manmatters.com':   { category: 'Beauty & Personal Care', subCategory: 'Men\'s Grooming' },
  'bombayshavingcompany.com':{ category: 'Beauty & Personal Care', subCategory: 'Men\'s Grooming' },
  // Electronics & Tech
  'apple.com':        { category: 'Electronics & Tech', subCategory: 'Consumer Electronics' },
  'samsung.com':      { category: 'Electronics & Tech', subCategory: 'Consumer Electronics' },
  'oneplus.in':       { category: 'Electronics & Tech', subCategory: 'Smartphones' },
  'mi.com':           { category: 'Electronics & Tech', subCategory: 'Consumer Electronics' },
  'boat-lifestyle.com':{ category: 'Electronics & Tech', subCategory: 'Audio & Wearables' },
  'noise.com':        { category: 'Electronics & Tech', subCategory: 'Audio & Wearables' },
  'croma.com':        { category: 'Electronics & Tech', subCategory: 'Electronics Retail' },
  'reliancedigital.in':{ category: 'Electronics & Tech', subCategory: 'Electronics Retail' },
  'sony.com':         { category: 'Electronics & Tech', subCategory: 'Consumer Electronics' },
  'dell.com':         { category: 'Electronics & Tech', subCategory: 'Computers & Laptops' },
  'hp.com':           { category: 'Electronics & Tech', subCategory: 'Computers & Laptops' },
  'lenovo.com':       { category: 'Electronics & Tech', subCategory: 'Computers & Laptops' },
  'bose.com':         { category: 'Electronics & Tech', subCategory: 'Premium Audio' },
  'jbl.com':          { category: 'Electronics & Tech', subCategory: 'Audio' },
  'dyson.com':        { category: 'Electronics & Tech', subCategory: 'Home Appliances' },
  // Home & Living
  'ikea.com':         { category: 'Home & Living', subCategory: 'Furniture & Home' },
  'woodenstreet.com': { category: 'Home & Living', subCategory: 'Furniture' },
  'pepperfry.com':    { category: 'Home & Living', subCategory: 'Furniture Marketplace' },
  'urbanladder.com':  { category: 'Home & Living', subCategory: 'Furniture' },
  'sleepycat.in':     { category: 'Home & Living', subCategory: 'Mattresses & Sleep' },
  'wakefit.co':       { category: 'Home & Living', subCategory: 'Mattresses & Sleep' },
  'sleepwell.co.in':  { category: 'Home & Living', subCategory: 'Mattresses & Sleep' },
  'godrejinterio.com':{ category: 'Home & Living', subCategory: 'Furniture' },
  'hometown.in':      { category: 'Home & Living', subCategory: 'Home Decor' },
  'nestasia.in':      { category: 'Home & Living', subCategory: 'Home Decor' },
  // Food & Beverage
  'chaipoint.com':    { category: 'Food & Beverage', subCategory: 'Cafe Chain' },
  'starbucks.com':    { category: 'Food & Beverage', subCategory: 'Cafe Chain' },
  'starbucks.in':     { category: 'Food & Beverage', subCategory: 'Cafe Chain' },
  'mcdonalds.com':    { category: 'Food & Beverage', subCategory: 'Quick Service Restaurant' },
  'dominos.com':      { category: 'Food & Beverage', subCategory: 'Quick Service Restaurant' },
  'dominos.co.in':    { category: 'Food & Beverage', subCategory: 'Quick Service Restaurant' },
  'kfc.com':          { category: 'Food & Beverage', subCategory: 'Quick Service Restaurant' },
  'subway.com':       { category: 'Food & Beverage', subCategory: 'Quick Service Restaurant' },
  'zomato.com':       { category: 'Food & Beverage', subCategory: 'Food Delivery' },
  'swiggy.com':       { category: 'Food & Beverage', subCategory: 'Food Delivery' },
  'blinkit.com':      { category: 'Food & Beverage', subCategory: 'Quick Commerce' },
  'zepto.co':         { category: 'Food & Beverage', subCategory: 'Quick Commerce' },
  'bigbasket.com':    { category: 'Food & Beverage', subCategory: 'Online Grocery' },
  'licious.in':       { category: 'Food & Beverage', subCategory: 'Fresh Meat & Seafood' },
  'countrydelight.in':{ category: 'Food & Beverage', subCategory: 'Farm Fresh Dairy' },
  // Outdoor & Sports
  'decathlon.in':     { category: 'Outdoor & Sports', subCategory: 'Sports Retail' },
  'decathlon.com':    { category: 'Outdoor & Sports', subCategory: 'Sports Retail' },
  'thenorthface.com': { category: 'Fashion & Apparel', subCategory: 'Outdoor & Adventure' },
  'columbia.com':     { category: 'Fashion & Apparel', subCategory: 'Outdoor & Adventure' },
  // Ecommerce Marketplaces
  'amazon.com':       { category: 'Ecommerce/Retail', subCategory: 'Marketplace' },
  'amazon.in':        { category: 'Ecommerce/Retail', subCategory: 'Marketplace' },
  'flipkart.com':     { category: 'Ecommerce/Retail', subCategory: 'Marketplace' },
  'myntra.com':       { category: 'Fashion & Apparel', subCategory: 'Fashion Marketplace' },
  'meesho.com':       { category: 'Ecommerce/Retail', subCategory: 'Social Commerce' },
  'snapdeal.com':     { category: 'Ecommerce/Retail', subCategory: 'Marketplace' },
  'jiomart.com':      { category: 'Ecommerce/Retail', subCategory: 'Online Grocery' },
  'tatacliq.com':     { category: 'Ecommerce/Retail', subCategory: 'Multi-Brand Retail' },
  // Books & Stationery
  'crossword.in':     { category: 'Books & Media', subCategory: 'Bookstore Chain' },
  'amazon.com':       { category: 'Ecommerce/Retail', subCategory: 'Marketplace' },
  // Eyewear
  'lenskart.com':     { category: 'Fashion Accessories', subCategory: 'Eyewear' },
  'johnjacobs.com':   { category: 'Fashion Accessories', subCategory: 'Eyewear' },
  'titaneyeplus.com': { category: 'Fashion Accessories', subCategory: 'Eyewear' },
  'vincesmallworld.com':{ category: 'Fashion Accessories', subCategory: 'Eyewear' },
  // Watches
  'titan.co.in':      { category: 'Fashion Accessories', subCategory: 'Watches' },
  'fastrack.in':      { category: 'Fashion Accessories', subCategory: 'Watches & Accessories' },
  'fossil.com':       { category: 'Fashion Accessories', subCategory: 'Watches' },
  'casio.com':        { category: 'Fashion Accessories', subCategory: 'Watches' },
  'rolex.com':        { category: 'Fashion Accessories', subCategory: 'Luxury Watches' },
  // Bags & Luggage
  'samsonite.com':    { category: 'Fashion Accessories', subCategory: 'Luggage & Travel' },
  'americantourister.com':{ category: 'Fashion Accessories', subCategory: 'Luggage & Travel' },
  'wildcraft.com':    { category: 'Fashion Accessories', subCategory: 'Backpacks & Outdoor' },
  'skybags.co.in':    { category: 'Fashion Accessories', subCategory: 'Bags & Luggage' },
  'mokobara.com':     { category: 'Fashion Accessories', subCategory: 'Luggage & Travel' },
  // Health & Wellness
  'cultfit.com':      { category: 'Health & Wellness', subCategory: 'Fitness & Gym' },
  'curefit.com':      { category: 'Health & Wellness', subCategory: 'Fitness & Gym' },
  'healthifyme.com':  { category: 'Health & Wellness', subCategory: 'Fitness App' },
  'pharmeasy.in':     { category: 'Health & Wellness Services', subCategory: 'Online Pharmacy' },
  'netmeds.com':      { category: 'Health & Wellness Services', subCategory: 'Online Pharmacy' },
  '1mg.com':          { category: 'Health & Wellness Services', subCategory: 'Online Pharmacy' },
  'practo.com':       { category: 'Health & Wellness Services', subCategory: 'Telemedicine' },
  // FinTech India
  'paytm.com':        { category: 'FinTech', subCategory: 'Digital Payments' },
  'phonepe.com':      { category: 'FinTech', subCategory: 'Digital Payments' },
  'razorpay.com':     { category: 'FinTech', subCategory: 'Payment Gateway' },
  'cred.club':        { category: 'FinTech', subCategory: 'Credit & Rewards' },
  'groww.in':         { category: 'FinTech', subCategory: 'Investment Platform' },
  'zerodha.com':      { category: 'FinTech', subCategory: 'Stock Trading' },
  'upstox.com':       { category: 'FinTech', subCategory: 'Stock Trading' },
  'policybazaar.com': { category: 'Insurance', subCategory: 'Insurance Marketplace' },
  // EdTech India
  'byjus.com':        { category: 'EdTech', subCategory: 'K-12 Learning' },
  'unacademy.com':    { category: 'EdTech', subCategory: 'Test Prep' },
  'vedantu.com':      { category: 'EdTech', subCategory: 'Online Tutoring' },
  'upgrad.com':       { category: 'EdTech', subCategory: 'Higher Education' },
  'simplilearn.com':  { category: 'EdTech', subCategory: 'Professional Courses' },
  'whitehatjr.com':   { category: 'EdTech', subCategory: 'Coding for Kids' },
  // Travel
  'makemytrip.com':   { category: 'Travel & Ticketing', subCategory: 'Travel Booking' },
  'goibibo.com':      { category: 'Travel & Ticketing', subCategory: 'Travel Booking' },
  'cleartrip.com':    { category: 'Travel & Ticketing', subCategory: 'Travel Booking' },
  'yatra.com':        { category: 'Travel & Ticketing', subCategory: 'Travel Booking' },
  'oyo.com':          { category: 'Travel & Ticketing', subCategory: 'Hotel Booking' },
  'booking.com':      { category: 'Travel & Ticketing', subCategory: 'Hotel Booking' },
  'airbnb.com':       { category: 'Travel & Ticketing', subCategory: 'Vacation Rentals' },
  // Automotive
  'cars24.com':       { category: 'Automotive', subCategory: 'Used Cars' },
  'cardekho.com':     { category: 'Automotive', subCategory: 'Car Research' },
  'spinny.com':       { category: 'Automotive', subCategory: 'Used Cars' },
  'ola.com':          { category: 'Transportation', subCategory: 'Ride-Hailing' },
  'uber.com':         { category: 'Transportation', subCategory: 'Ride-Hailing' },
  'rapido.bike':      { category: 'Transportation', subCategory: 'Ride-Hailing' },
  // Real Estate
  '99acres.com':      { category: 'Real Estate', subCategory: 'Property Listing' },
  'magicbricks.com':  { category: 'Real Estate', subCategory: 'Property Listing' },
  'housing.com':      { category: 'Real Estate', subCategory: 'Property Listing' },
  'nobroker.in':      { category: 'Real Estate', subCategory: 'Rental Platform' },
};
...
async function scrapeStoreLocatorWithBrowser(storeLocatorUrl, browserFetch) {
  ...
  try {
    result = await Promise.race([
      ...
      new Promise((_, reject) => setTimeout(() => reject(new Error('browser timeout')), 8000)),
    ]);
  } catch {
    return 0;
  }
...
async function detectOfflineStores(html, url, technologies, fetchPage, storeLocatorUrl, jsonLdStoreHint, browserFetch) {
  ...
  // Start Wikipedia lookup in parallel — we'll use it for cross-validation
  ...
  if (widgetCount > 0) return countToBand(widgetCount);
  ...
  if (storeLocatorHtml) {
    ...
    if (renderedCount > 0) return countToBand(renderedCount);
  }
  ...
  // Only brute-force store pages if the site looks like it could have stores
  ...
  const wikiCount = await wikiPromise;
  if (wikiCount > 0) return countToBand(wikiCount);

  if (hasStoreSignal) {
    const commonPageCount = await tryCommonStorePages(url, fetchPage);
    if (commonPageCount > 0) return countToBand(commonPageCount);

    // Last resort: single browser-based scrape of store locator
...
async function extractCompanyMeta({ url, html, headers, metaMap, technologies, fetchPage, browserFetch, forceRefresh }) {
  ...
  if (noStoreBizTypes.includes(category)) {
    ...
    try {
      ...
      offlineStores = await Promise.race([
        ...
        new Promise(resolve => setTimeout(() => resolve(timeoutFallback), 20000)),
      ]);
    } catch {
  ...
  try {
    ...
    // Check for existing overrides and apply them to the result
    const existing = await db.collection('company_meta').findOne({ normalizedDomain });
    if (existing?.overrides) {
      if (existing.overrides.region) result.region = existing.overrides.region;
      if (existing.overrides.offlineStores) result.offlineStores = existing.overrides.offlineStores;
      if (existing.overrides.category) result.category = existing.overrides.category;
      if (existing.overrides.subCategory) result.subCategory = existing.overrides.subCategory;
    }
