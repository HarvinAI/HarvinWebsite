    ...
    <footer className="bg-[#0C0B09] text-white">
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-16
        ...
        <div className="col-span-2 md:col-span-1 flex flex-col gap-6 pr-4">
          ...
          <p className="text-[13.5px] font-sans leading-[1.7] text-white/45 max-w-[240px]">
            D2C brand intelligence that tells you which brands are ready to buy — before your competitors find out.
          </p>
        ...
        {NAV_COLS.map((col) => (
          <div key={col.heading} className="flex flex-col gap-3">
            <p className="text-[11px] font-semibold font-sans tracking-[0.08em] uppercase
                           text-white/30 mb-2">
              {col.heading}
            </p>
            {col.links.map((label) => (
